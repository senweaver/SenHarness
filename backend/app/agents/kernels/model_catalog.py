...
CATALOG: dict[str, list[CatalogModel]] = {
    ...
    "openai": [
        CatalogModel("openai", "gpt-5.5", "GPT-5.5", "frontier", description="Latest frontier reasoning + tools."),
        CatalogModel("openai", "gpt-5.4", "GPT-5.4", "frontier"),
        CatalogModel("openai", "gpt-5.4-mini", "GPT-5.4 Mini", "balanced", recommended=True, description="Cheap and fast — default."),
        ...
        CatalogModel("openai", "o3", "o3", "reasoning", description="Best at multi-step reasoning."),
        CatalogModel("openai", "o4-mini", "o4 Mini", "reasoning"),
        CatalogModel(
            "openai", "text-embedding-3-small", "Text Embedding 3 Small", "embedding",
            recommended=True, category="embedding",
            description="1536-d embeddings — default cost/quality tradeoff.",
        ),
        CatalogModel(
            "openai", "text-embedding-3-large", "Text Embedding 3 Large", "embedding",
            category="embedding", description="3072-d embeddings — higher quality.",
        ),
    ],
    "anthropic": [
        CatalogModel("anthropic", "claude-opus-4.7", "Claude Opus 4.7", "frontier", description="Top-tier writing + analysis."),
        CatalogModel("anthropic", "claude-opus-4.6", "Claude Opus 4.6", "frontier"),
        CatalogModel("anthropic", "claude-sonnet-4.6", "Claude Sonnet 4.6", "balanced", recommended=True),
    ...
    "google": [
        ...
        CatalogModel("google", "gemini-3-flash-preview", "Gemini 3 Flash Preview", "balanced", recommended=True),
        CatalogModel("google", "gemini-2.5-pro", "Gemini 2.5 Pro", "frontier"),
        CatalogModel("google", "gemini-2.5-flash", "Gemini 2.5 Flash", "balanced"),
    ],
    "xai": [
        CatalogModel("xai", "grok-4.20-reasoning", "Grok 4.20 Reasoning", "reasoning", recommended=True),
    ...
    "azure_openai": [
        ...
        CatalogModel(
            "azure_openai", "text-embedding-3-small", "Text Embedding 3 Small (Azure)",
            "embedding", recommended=True, category="embedding",
            description="Azure deployment name must match this id.",
        ),
        CatalogModel(
            "azure_openai", "text-embedding-3-large", "Text Embedding 3 Large (Azure)",
            "embedding", category="embedding",
        ),
    ],
    "huggingface": [
        CatalogModel("huggingface", "Qwen/Qwen3.5-397B-A17B", "Qwen3.5 397B-A17B", "frontier", recommended=True),
    ...
    "deepseek": [
        ...
        CatalogModel("deepseek", "deepseek-v4-flash", "DeepSeek V4 Flash", "balanced", recommended=True),
    ...
    "dashscope": [
        CatalogModel(
            "dashscope", "qwen3.6-plus", "Qwen 3.6 Plus", "frontier",
            recommended=True,
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "qwen3.5-plus", "Qwen 3.5 Plus", "frontier",
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "qwen3-max-2026-01-23", "Qwen3 Max (2026-01-23)", "frontier",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "qwen3-coder-plus", "Qwen3 Coder Plus", "coding",
            capabilities=("chat", "coding", "tools"),
        ),
        CatalogModel(
            "dashscope", "qwen3-coder-next", "Qwen3 Coder Next", "coding",
            capabilities=("chat", "coding", "tools"),
        ),
        CatalogModel(
            "dashscope", "glm-5", "GLM-5 (DashScope)", "balanced",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "kimi-k2.5", "Kimi K2.5 (DashScope)", "balanced",
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "MiniMax-M2.5", "MiniMax M2.5 (DashScope)", "balanced",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "dashscope", "text-embedding-v3", "Tongyi Embedding v3", "embedding",
            recommended=True, category="embedding",
            description="1024-d 通义嵌入 v3.",
        ),
        CatalogModel(
            "dashscope", "text-embedding-v2", "Tongyi Embedding v2", "embedding",
            category="embedding",
        ),
    ],
    "bailian_token": [
        CatalogModel(
            "bailian_token", "qwen3.6-plus", "Qwen 3.6 Plus", "frontier",
            recommended=True,
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_token", "qwen3.5-plus", "Qwen 3.5 Plus", "frontier",
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_token", "qwen3-coder-plus", "Qwen3 Coder Plus", "coding",
            capabilities=("chat", "coding", "tools"),
        ),
        CatalogModel(
            "bailian_token", "qwen3-max-2026-01-23", "Qwen3 Max (2026-01-23)", "frontier",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_token", "qwen-long", "Qwen Long", "balanced",
            description="Long-context bundle SKU.",
            capabilities=("chat", "tools"),
            context_window=10_000_000,
        ),
        CatalogModel(
            "bailian_token", "text-embedding-v3", "通义嵌入 v3", "embedding",
            recommended=True, category="embedding",
        ),
    ],
    "bailian_coding": [
        CatalogModel(
            "bailian_coding", "qwen3.6-plus", "Qwen 3.6 Plus", "frontier",
            recommended=True,
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "qwen3.5-plus", "Qwen 3.5 Plus", "frontier",
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "qwen3-max-2026-01-23", "Qwen3 Max (2026-01-23)", "frontier",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "qwen3-coder-next", "Qwen3 Coder Next", "coding",
            capabilities=("chat", "coding", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "qwen3-coder-plus", "Qwen3 Coder Plus", "coding",
            capabilities=("chat", "coding", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "glm-5", "GLM-5", "balanced",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "glm-4.7", "GLM-4.7", "balanced",
            capabilities=("chat", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "kimi-k2.5", "Kimi K2.5", "balanced",
            capabilities=("chat", "vision", "reasoning", "tools"),
        ),
        CatalogModel(
            "bailian_coding", "MiniMax-M2.5", "MiniMax M2.5", "balanced",
            capabilities=("chat", "reasoning", "tools"),
        ),
    ],
    ...
    "zhipu": [
        ...
        CatalogModel("zhipu", "glm-5v-turbo", "GLM-5V Turbo", "balanced", description="Vision multimodal."),
        ...
        CatalogModel(
            "zhipu", "embedding-3", "Zhipu Embedding 3", "embedding",
            recommended=True, category="embedding",
            description="2048-d embedding v3.",
        ),
        CatalogModel(
            "zhipu", "embedding-2", "Zhipu Embedding 2", "embedding",
            category="embedding",
        ),
    ],
    "siliconflow": [
        CatalogModel("siliconflow", "deepseek-ai/DeepSeek-V3.2", "DeepSeek V3.2", "balanced", recommended=True),
        ...
        CatalogModel("siliconflow", "meta-llama/Llama-3.3-70B-Instruct", "Llama 3.3 70B", "balanced"),
        CatalogModel(
            "siliconflow", "BAAI/bge-m3", "BGE M3 (multi-lingual)", "embedding",
            recommended=True, category="embedding",
            description="1024-d multilingual embeddings.",
        ),
        CatalogModel(
            "siliconflow", "BAAI/bge-large-zh-v1.5", "BGE Large Chinese v1.5",
            "embedding", category="embedding",
        ),
    ],
    "minimax": [
    ...
    "ollama": [
        ...
        CatalogModel("ollama", "qwen3-coder-30b-a3b", "Qwen3 Coder 30B-A3B (local)", "coding", recommended=True),
        CatalogModel("ollama", "deepseek-v3-distill", "DeepSeek V3 Distill (local)", "local"),
        CatalogModel("ollama", "mistral", "Mistral (local)", "local"),
        CatalogModel(
            "ollama", "nomic-embed-text", "Nomic Embed Text (local)", "embedding",
            recommended=True, category="embedding",
            description="768-d open embedder via Ollama native /api/embeddings.",
        ),
        CatalogModel(
            "ollama", "mxbai-embed-large", "MixedBread Embed Large (local)",
            "embedding", category="embedding",
        ),
    ],
    "vllm": [],
