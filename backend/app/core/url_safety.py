...
def assert_safe_url(url: str, *, allow_private: bool = False) -> str:
    ...
    # Resolve the host; reject if any of the resolved addresses point at
    # a dangerous range. We always catch metadata IPs even when
    # ``allow_private`` is set — those addresses have no legitimate use.
