  ...
  const submit = async () => {
    try {
      ...
      const knownKey: Record<string, string> = {
        ...
        docx_lib_missing: "error.docx_lib_missing",
        docx_parse_failed: "error.docx_parse_failed",
        docx_empty: "error.docx_empty",
        xlsx_lib_missing: "error.xlsx_lib_missing",
        xlsx_parse_failed: "error.xlsx_parse_failed",
        xlsx_empty: "error.xlsx_empty",
