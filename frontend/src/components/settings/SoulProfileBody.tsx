...
/**
 * Body of the SOUL.md / USER.md tab. Extracted from the dedicated
 * `/settings/profile/soul` route so we can render it inline under
 * `/settings/profile?tab=soul` without forcing a route navigation
 * — that's the "one less page jump" win plan §6 calls out.
 */
export function SoulProfileBody() {
